...
const DeliveryMessagePub = (props) => {
    ...
    return (
        <div className={clsx('modal fade', props.show ? 'show' : '')} id='kt_modal_delivery_message_pub' aria-hidden='true' style={{ display: props.show ? 'block' : 'none' }}>
